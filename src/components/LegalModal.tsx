      ...
      <Box sx={modalStyle}>
        ...
        <section style={{ marginTop: '1.5rem' }}>
          ...
          <Typography variant="body2" paragraph>
            ...
            analysis. Vercel Analytics does not store cookies or other personal
        ...
        <section style={{ marginTop: '1.5rem' }}>
          ...
          <Typography variant="body2" paragraph>
            <strong>Data Accuracy:</strong> All air quality data is provided “as
            is” from third-party sources (e.g., OpenAQ). We make no guarantee of
            its accuracy or timeliness. You acknowledge that any reliance on
            this data is at your own risk.
          </Typography>
          <Typography variant="body2" paragraph>
            <strong>Liability:</strong> We are not liable for damages arising
            from the use or inability to use our website or the information
            provided. The information on MapTheAir.com is for general
            informational purposes only and should not be relied upon for
            medical, health, or safety decisions without consulting relevant
            professionals.
          </Typography>
          <Typography variant="body2" paragraph>
            <strong>Usage Restrictions:</strong> You agree not to misuse the
            website. This includes refraining from unlawful activities,
            attempting to break the site, or spamming the service. We reserve
            the right to modify or discontinue any feature at any time.
          </Typography>
          <Typography variant="body2" paragraph>
            These Terms and this Disclaimer are governed by the laws of Germany.
            Any disputes arising shall be settled in the courts of Berlin,
            Germany.
          </Typography>
        </section>
